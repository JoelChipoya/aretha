...
TITLE:Group PA
ORG:IJG namibia
EMAIL;type=WORK: aretha@ijg.net
TEL;type=CELL: +264819583540
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl">
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Aretha Thiart</h1>
                <p className="text-lg font-medium text-[#094794]">Wealth Manager</p>
              </div>
            </div>
